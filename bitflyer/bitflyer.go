...
func (api *APIClient) GetBalance() ([]Balance, error) {
	...
	log.Printf("url=%s", url, string(resp))
	if err != nil {
...
// TickerAPIでBitcoinのデータをリアルタイムで取得する
...
// JsonRPC2.0 over websocketでTickerをリアルタイムで取得(Pubnubの代理)
